...
def generate_sequential_id() -> str:
    """
    Generate a sequential 8-digit ID for submissions
    ...
    try:
        ...
        response = schemas_table.update_item(
            ...
            UpdateExpression='ADD submission_counter :inc',
        ...
        fallback_id = f"{int(datetime.utcnow().timestamp()):08d}"
...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            # Create subject line with format: "Dock2Gdansk {ID_number}@wersja {schema version number}"
