...
"""
            ...
            msg = MIMEMultipart()
            msg['Subject'] = subject
            msg['From'] = 'no-reply@d2g.dagodigital.com'
            msg['To'] = 'walpole.mike@gmail.com'
            ...
            # Send raw email
            ses.send_raw_email(
                Source='no-reply@d2g.dagodigital.com',
                Destinations=['walpole.mike@gmail.com'],
                RawMessage={'Data': msg.as_string()}
            )
            
            print(f"Admin notification email sent successfully to walpole.mike@gmail.com")
